...
import tfcLogo from '../assets/tfcLogo.svg';
import carShop from '../assets/carShop.svg';
import blogApi from '../assets/blogApi.svg';
...
export const projectsBackendPortuguese = [
  ...
  },
  {
    ...
    img: tfcLogo,
    deploy: '',
    repository: 'https://github.com/ramondfalcao/project-tfc',
    bloco: "backend",
  },
  {
    title: 'Car Shop API',
    description: 'API CRUD para gerenciar uma concessionária de veículos',
    img: carShop,
    deploy: '',
    repository: 'https://github.com/ramondfalcao/project-car-shop-api',
    bloco: "backend",
  },
]
...
export const projectsBackend = [
  {
    title: 'Blogs API',
    description: 'Api for producing content for a blog.',
    img: blogApi,
    deploy: '',
    repository: 'https://github.com/ramondfalcao/project-blogs-api',
    bloco: "backend",
  ...
  {
    title: 'Car Shop API',
    description: 'CRUD API to manage a car dealership',
    img: carShop,
    deploy: '',
    repository: 'https://github.com/ramondfalcao/project-car-shop-api',
    bloco: "backend",
